...
"""
Module: cocomo.py
Description: Run the COCOCMO2 MD simulation.
Usage:
...
def run_sim(prm_file):
    ...
    ff_param = {'ALA': {'mass':  71.079, 'charge':  0.0, 'radius': 0.2845, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 0.796},
                ...
                'CYS': {'mass': 103.139, 'charge':  0.0, 'radius': 0.3024, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.074},
                ...
                'GLY': {'mass':  57.052, 'charge':  0.0, 'radius': 0.2617, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 0.544},
                'HIS': {'mass': 137.142, 'charge':  0.0, 'radius': 0.3338, 'epsilon': eps_polar, 'azero': azero_polar, 'surface': 1.634},
                'ILE': {'mass': 113.160, 'charge':  0.0, 'radius': 0.3360, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.410},
                'LEU': {'mass': 113.160, 'charge':  0.0, 'radius': 0.3363, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.519},
                'LYS': {'mass': 129.183, 'charge':  1.0, 'radius': 0.3439, 'epsilon': eps_polar, 'azero': azero_polar, 'surface': 1.923},
                'MET': {'mass': 131.193, 'charge':  0.0, 'radius': 0.3381, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.620},
                'PHE': {'mass': 147.177, 'charge':  0.0, 'radius': 0.3556, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.869},
                'PRO': {'mass':  98.125, 'charge':  0.0, 'radius': 0.3187, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 0.974},
                ...
                'TRP': {'mass': 186.214, 'charge':  0.0, 'radius': 0.3754, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 2.227},
                'TYR': {'mass': 163.176, 'charge':  0.0, 'radius': 0.3611, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 2.018},
                'VAL': {'mass':  99.133, 'charge':  0.0, 'radius': 0.3205, 'epsilon': eps_nopol, 'azero': azero_nopol, 'surface': 1.232},
                'ADE': {'mass': 315.697, 'charge': -1.0, 'radius': 0.4220, 'epsilon': eps_rna,   'azero': azero_rna},
                'CYT': {'mass': 305.200, 'charge': -1.0, 'radius': 0.4110, 'epsilon': eps_rna,   'azero': azero_rna},
                'GUA': {'mass': 345.200, 'charge': -1.0, 'radius': 0.4255, 'epsilon': eps_rna,   'azero': azero_rna},
                'URA': {'mass': 305.162, 'charge': -1.0, 'radius': 0.4090, 'epsilon': eps_rna,   'azero': azero_rna}}
    ...
    def read_pdb(filename):
        ...
        with open(filename, 'r') as f:
            for line in f:
                parts = line.split()
                if parts[0] == 'ATOM':
                    atoms.append([parts[2], parts[3], parts[-2]])
    ...
    if any(atom.residue.name in ['PHE', 'TRP', 'TYR'] for atom in top.atoms()):
